...
$alert = "";
if(isset($_POST['newtestsubmit'])){
    $newclassname = $_POST['newtestcode'];
    $alert = join_test($newclassname, $email);
}
}
else{
...
document.addEventListener("visibilitychange", function() {
 ...
 x.click();
    ...
    <div class="butt2" onclick="pop()" type="button">Join New Test</div>
    ...
    <section>
        <table class="table table-bordered border-light table-dark table-hover">
                ...
                <p id="classlist"> <i> <?php load_exam($email) ?> </i> </p>

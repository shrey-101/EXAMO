...
if(isset($_POST['register'])){
    ...
    if(!ifemailexiest($email)){
        $sql = "INSERT into userinfo (fullname, email, psw, institute, rolelevel, verified) VALUES ('$fullname', '$email', '$psw', '$institute', 'examinee', 'yes')";
        if($conn->query($sql)){
...
<!-- Form-->
    <section class="register-form">
       ...
       <form action="" method="POST">
        ...
        <input type="file" id="institute" type="image" required/> <br><br>
